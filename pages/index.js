...
const Landing = () => {
  ...
  ref = {mapRef} style =
  {
    { width: "500px", height: "500px", }
      ...
      <h2 className = {"text-2xl text-center font-semibold text-red-600"}>But
          few get it<
              /h2>
  ...
  className =
      ...
      <p className = {"text-center min-w-medium max-w-md w-2/3 text-lg"}>You can
          impact your community,
  help others and contribute to global
