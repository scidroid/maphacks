  ...
  return (
    <>
      <section className={"flex flex-col items-center justify-center"}>
        <canvas ref={mapRef} style={{ width: "500px", height: "500px" }} />
      ...
      >
        ...
        <article className={"m-4 max-w-sm"}>
          <h2 className="text-5xl m-2 font-bold text-center">
            Our misssion is help without comissions
          </h2>
          <ul>
      ...
      >
        <section className={"flex flex-col justify-center items-center"}>
          ...
          <p className={"m-4 text-xl text-center max-w-lg"}>
            You already have everything to start, login and help your community
            in minutes.
          </p>
        </section>
        <Link href={isLoading ? "/" : user ? "/app" : "/api/auth/login"}>
